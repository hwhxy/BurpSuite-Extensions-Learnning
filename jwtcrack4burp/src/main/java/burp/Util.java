...
public class Util {
    ...
    public static String insertFuzzUrl(String url) {
        Config.setRequstUrl(url);
        return Config.getRequsturl();
    }

    /*
    public static String makeBatFile(String filename,String content){
        Properties properties = System.getProperties();//system运行时的一些信息
